...
while True:
    ...
    font = pygame.font.Font("snake_src/arcade_font.ttf", 18)
    ...
    lives_text = font.render(f"Lives: {lives}", True, (255, 255, 0))  # Жёлтый цвет
    screen.blit(score_text, (WIDTH - 150, 20))
    screen.blit(record_text, (WIDTH - 150, 60))
    screen.blit(lives_text, (WIDTH - 150, 100))

    pygame.display.flip()
    for i in range(lives):
        pygame.draw.rect(screen, PASTEL_RED, (WIDTH - 150 + i * 30, 120, 20, 20))  # Отрисовка сердец
