...
game_prize = 0
game_spins = 0
total_spins = 1_000  # заданное количество спинов
...
while total_spins_played < total_spins:
    ...
    for row in (tables_main_and_free.free_table if free_spin else tables_main_and_free.main_table):
...
print("Общий частотный анализ игры main+free:")
